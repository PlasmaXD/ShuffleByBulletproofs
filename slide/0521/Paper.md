...
* **Table 1**: 単一実行あたりの計算時間・通信量・証明鍵サイズ・制約数（Geolife／Smart meter, Base／Expand／Shuffle）を示す 。

\| データセット / スキーム | クライアント<BR>GenRand-1 (ms) | 同 GenRand-2 (ms) | 同 Randomize (s) | サーバー<BR>GenRand (ms) | 同 Verify (ms) | 通信送信<BR>bytes | 通信受信<BR>bytes | |ek| | |vk| | 制約数 |
\|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
\| **Smart meter Base** | 0.223 | 0.213 | 0.619 | 2.146 | 3.484 | 同上 | 同上 | 16.3 MB | 776 B | 56 903 |
\| **Smart meter Expand** | 2.475 | 0.211 | 1.106 | 1.271 | 3.540 | 同上 | 同上 | 23.7 MB | 824 B | 75 341 |
\| **Smart meter Shuffle** | 0.225 | 0.293 | 1.821 | 2.119 | 2.659 | 同上 | 同上 | 53.3 MB | 728 B | 174 095 |
